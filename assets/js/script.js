...
/*------------------------------------------
    ...
    if ($("#clock").length) {
        ...
        const countDownDate = dayjs("2022-11-10 11:00:00");
        const diff = dayjs.preciseDiff(dayjs(), countDownDate, true);
        $("#clock").html(`
            <div class="box"><div><div class="time">${diff.months}</div> <span>Month</span> </div></div>
            <div class="box"><div><div class="time">${diff.days}</div> <span>Days</span> </div></div>
            <div class="box"><div><div class="time">${diff.hours}</div> <span>Hours</span> </div></div>
            <div class="box"><div><div class="time">${diff.minutes}</div> <span>Mins</span> </div></div>
            <div class="box"><div><div class="time">${diff.seconds}</div> <span>Secs</span> </div></div>
        `);
